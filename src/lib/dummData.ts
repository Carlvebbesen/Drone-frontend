import { SelectedArea } from "@/components/dashboard/dashboard";
...
export const drones = [
  {
    ...
    pos: {
      lngLat: {
        lng: 10.402711764853564,
        lat: 63.41666225093931,
      },
      zLevel: 1,
    },
  },
  {
    ...
    pos: {
      lngLat: {
        lng: 10.402356883472379,
        lat: 63.417054415314254,
      },
      zLevel: 1,
    },
  },
  {
    ...
    pos: {
      lngLat: {
        lng: 10.402183019889577,
        lat: 63.41718124381393,
      },
      zLevel: 1,
    },
  },
  {
    ...
    pos: {
      lngLat: {
        lng: 10.402780870252087,
        lat: 63.416564401553586,
      },
      zLevel: 1,
    },
  },
  {
    ...
    pos: {
      lngLat: {
        lng: 10.403065652766543,
        lat: 63.416348817192244,
      },
      zLevel: 1,
    },
  },
  {
    ...
    pos: {
      lngLat: {
        lng: 10.403675931527829,
        lat: 63.41638524840678,
      },
      zLevel: 1,
    },
  },
  {
    ...
    pos: {
      lngLat: {
        lng: 10.403383496146887,
        lat: 63.416669370677994,
      },
      zLevel: 1,
    },
  },
  {
    ...
    pos: {
      lngLat: {
        lng: 10.402900165263162,
        lat: 63.41728075120099,
      },
      zLevel: 1,
    },
  },
  {
    id: "840e74a1-asd3-234d-2b1c-885cf742ed5a",
    name: "Drone10",
    isConnected: false,
    lastUsed: "1970-09-14T04:34:38.074Z",
    building: "Rockheim",
    ...
    pos: {
      lngLat: {
        lng: 10.403394613538978,
        lat: 63.416848714470206,
      },
      zLevel: 1,
    },
  },
...
export const testHeatmap = {
  ...
  geometry: {
    type: "Point",
    coordinates: [
      [10.404891470496665, 63.415437561455974],
      [10.405026698092996, 63.415463413283135],
      [10.40521308726062, 63.415498362769995],
      [10.405365382417699, 63.4155300899418],
      [10.4055565554294, 63.41556552222406],
      [10.405676028353582, 63.41559548670608],
      [10.405815817811003, 63.4156216849527],
      [10.405923474732504, 63.41564636153868],
      [10.406094161884027, 63.41567789441706],
      [10.406216260587229, 63.41570433356375],
      [10.406345257861233, 63.41573290381166],
      [10.406454227671219, 63.415752292484285],
      [10.40655138147855, 63.41577461881843],
      [10.40669524331011, 63.41580524096767],
      [10.406842286910091, 63.41583461766524],
      [10.406988017620591, 63.4158634067997],
      [10.406876827068686, 63.415844009123646],
      [10.406768349813689, 63.415823782094634],
      [10.406612865749366, 63.415788991571134],
      [10.406486308951457, 63.41576229183838],
      [10.40638506351334, 63.4157420647517],
      [10.406276586258315, 63.41571941039757],
      [10.406124912379255, 63.415691026510814],
      [10.406011011261938, 63.41566270851487],
      [10.40586637492234, 63.41563681775136],
      [10.405713212518748, 63.415605567599414],
      [10.40561015912607, 63.41558210404932],
      [10.405485410282722, 63.415555404123864],
      [10.405278361163255, 63.41551528008293],
      [10.405119261188588, 63.4154829164585],
      [10.40493357367501, 63.415449428405566],
      [10.404147945930333, 63.4155844295353],
      [10.404179839764936, 63.415546368185176],
      [10.404240083674324, 63.41549482669333],
      [10.404349940214331, 63.4155106856239],
      [10.404438534199642, 63.41552892338305],
      [10.404555478258374, 63.415551125856894],
      [10.404658247279741, 63.41557491420264],
      [10.4046901411144, 63.4155844295353],
      [10.404647616002308, 63.41563279909457],
      [10.40462103780635, 63.41565658737255],
      [10.404668878558368, 63.41560980374055],
      [10.404734438106374, 63.415543196403775],
      [10.40479740472395, 63.41548427663545],
      [10.404854104873323, 63.415430356186135],
      [10.404763739165674, 63.415410532520184],
      [10.40463084818839, 63.41538912288729],
      [10.404492641573626, 63.41535502603128],
      [10.404471379017593, 63.41531537847328],
      [10.40439873194967, 63.41534868242579],
      [10.404349119318908, 63.4153986382816],
      [10.404281787890966, 63.4154589023731],
      [10.404199196339306, 63.415533704259644],
    ],
  },
};

export const area: { [index: string]: SelectedArea[] } = {
  "1": [
    { floorId: "1", id: "1_section:1", name: "A3", robotType: "drone" },
    { floorId: "1", id: "1_section:2", name: "hei", robotType: "drone" },
    { floorId: "1", id: "1_section:3", name: "hei2", robotType: "drone" },
    { floorId: "1", id: "1_section:4", name: "hei3", robotType: "drone" },
    { floorId: "1", id: "1_section:5", name: "hei4", robotType: "drone" },
  ],
  "2": [
    { floorId: "2", id: "2_section:1", name: "A2", robotType: "drone" },
    { floorId: "2", id: "2_section:2", name: "he2", robotType: "drone" },
    { floorId: "2", id: "2_section:3", name: "hei2", robotType: "drone" },
    { floorId: "2", id: "2_section:4", name: "hei2", robotType: "drone" },
    { floorId: "2", id: "2_section:5", name: "hei2", robotType: "drone" },
  ],
  "3": [
    { floorId: "3", id: "3_section:1", name: "A3", robotType: "drone" },
    { floorId: "3", id: "3_section:5", name: "hei3", robotType: "drone" },
  ],
  "4": [
    { floorId: "4", id: "4_section:1", name: "A4", robotType: "drone" },
    { floorId: "4", id: "4_section:2", name: "he4", robotType: "drone" },
    { floorId: "4", id: "4_section:3", name: "hei4", robotType: "drone" },
  ],
  "5": [{ floorId: "5", id: "5_section:1", name: "A5", robotType: "drone" }],
  u1: [
    { floorId: "u1", id: "u1_section:1", name: "A3uu1", robotType: "drone" },
    { floorId: "u1", id: "u1_section:2", name: "heiuu1", robotType: "drone" },
    {
      floorId: "u1",
      id: "u1_section:4",
      name: "hei3uu1",
  ...
  u2: [
    { floorId: "u2", id: "u2_section:1", name: "A3uu2", robotType: "drone" },
    { floorId: "u2", id: "u2_section:2", name: "heiuu2", robotType: "drone" },
  ...
  u3: [
    { floorId: "u3", id: "u3_section:1", name: "A3uu3", robotType: "drone" },
    { floorId: "u3", id: "u3_section:2", name: "heiuu3", robotType: "drone" },
    {
      floorId: "u3",
      id: "u3_section:3",
      name: "hei2uu3",
  ...
  u4: [
    { floorId: "u4", id: "u4_section:1", name: "A3uu4", robotType: "drone" },
    { floorId: "u4", id: "u4_section:2", name: "heiuu4", robotType: "drone" },
  ],
};
